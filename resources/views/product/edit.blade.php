        ...
        <div class="p-2 text-dark">
          <form action="{{ route('edit-product', $product) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        border border-danger @enderror" value="{{ $product->name }}" id="name">
                        @error('name')
                            <div class="text-danger mt-2 fs-6">
                                {{ $message }}
                            </div>
            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        border border-danger @enderror" value="{{ $product->amount }}" id="amount">
                        @error('amount')
                            <div class="text-danger mt-2 fs-6">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        border border-danger @enderror" value="{{ $product->unit }}" id="unit" placeholder="E.g. Packets, Kg, Litre">
                        @error('unit')
                            <div class="text-danger mt-2 fs-6">
                                {{ $message }}
                            </div>
            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        border border-danger @enderror" value="{{ $product->cost }}" id="cost">
                        @error('cost')
                            <div class="text-danger mt-2 fs-6">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        border border-danger @enderror" value="{{ $product->price }}" id="price">
                        @error('price')
                            <div class="text-danger mt-2 fs-6">
                                {{ $message }}
                            </div>
            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        border border-danger @enderror" value="{{ $product->quantity }}" id="quantity">
                        @error('quantity')
                            <div class="text-danger mt-2 fs-6">
                                {{ $message }}
                            </div>
            ...
            <div class="mb-3">
              ...
              <textarea name="description" id="description" cols="30" class="form-control">{{ $product->description }}</textarea>
            </div>
